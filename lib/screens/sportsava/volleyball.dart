    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          GestureDetector(
              onTap: () {
                BookedSlot(nav: service.volSlot()).launch(context);
              },
              child: const FaIcon(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            ...
            Text(
              maxLines: 100,
              "Volleyball is a team sport in which two teams of six players are separated by a net. Each team tries to scorepoints by grounding a ball on the other team's court under organized rules.[1] It has been a part of the official program of the Summer Olympic Games since Tokyo 1964. Beach volleyball was introduced to the programme at the Atlanta 1996. The adapted version of volleyball at the Summer Paralympic Games is sitting volleyball.",
            ...
            Row(
              ...
              children: [
                AppButton(
                  ...
                  color: white,
                  onTap: () {
                    ViewSlot(nav: service.volSlot(), slot: 'volSlot',).launch(context);
                  },
